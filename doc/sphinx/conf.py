...
def ConfigProject(app, config):
    ...
    xml_dir = os.path.join(os.path.dirname(app.outdir), 'xml')
    ...
    subprocess.check_call(
            ['doxygen', 'doc/sphinx/Doxyfile.doc'],
...
# Static files (images, style sheets, etc). Directory relative to this file.
html_static_path = ['_static']

exclude_patterns = ['doc/sphinx']
